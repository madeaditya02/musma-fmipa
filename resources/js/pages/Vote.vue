      ...
      <div class="md:w-6/12 mx-auto mt-12">
        ...
        <div class="h-full pb-16">
            <div class="w-full flex justify-between items-start relative">
                ...
                <h1 class="text-xl sm:text-3xl lg:text-4xl font-bold text-center text-white uppercase absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2"
                    style="text-shadow:
   -2px -2px 0 #A50000,
    2px -2px 0 #A50000,
    -2px 2px 0 #A50000,
     2px 2px 0 #A50000;">Pemilihan Ketua DPM FMIPA 2026
            ...
            <div class="flex flex-wrap px-4">
                <div class="h-120 flex flex-col justify-between w-full sm:w-1/2"
                    v-for="(kandidat, i) in kegiatan.kandidat" :key="kandidat.id"
