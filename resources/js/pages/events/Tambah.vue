...
const form = useForm({
  nama: '',
  waktu_mulai_tanggal: undefined as any,
  waktu_mulai_jam: '',
  waktu_selesai_tanggal: undefined as any,
  waktu_selesai_jam: ''
})
</script>
<template>
  <AppLayout>
    ...
    })).post(`/events`)" class="container mx-auto px-8 py-10">
      <h1 class="text-3xl font-semibold">Tambah Data Kegiatan</h1>
