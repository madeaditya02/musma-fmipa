...
class KandidatController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($existingKandidat) {
                return redirect()->back()->with('alert', ['type' => 'error', 'message' => 'Nomor urut sudah digunakan untuk kegiatan ini.']);
            }
            ...
            return to_route('candidates.index')->with('alert', ['type' => 'success', 'title' => 'Berhasil menambah kandidat', 'message' => 'Data kandidat berhasil dibuat']);
        } catch (\Exception $e) {
            return back()->with('alert', ['type' => 'error', 'title' => 'Terjadi kesalahan', 'message' => 'Terjadi kesalahan saat menambah data kandidat: ' . $e->getMessage()]);
        }
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            // Redirect with success message
            return to_route('candidates.index')->with('alert', ['type' => 'success', 'title' => 'Berhasil mengedit kandidat', 'message' => 'Data kandidat berhasil diedit']);
        } catch (\Exception $e) {
            return back()->with('alert', ['type' => 'error', 'message' => 'Terjadi kesalahan saat memperbarui data kandidat: ' . $e->getMessage()]);
        }
    }
